...
build_radar_data <- function(data, player_a, player_b) {
  ...
  colnames(out) <- radar_labels[colnames(out)] # uses the proper variable labels from var_labels
  out # return out
}

# run function for the two players of interest
radardata<-build_radar_data(player_means, "Rafael Nadal", "John Isner")
radardata
```
...
build_radar_table(player_means, "Rafael Nadal", "John Isner") |>
  gt() |>
